...
function carzine_the_breadcrumb()
{
    ...
    if (is_tag()) {
        ...
        echo "<li>" . __('Archive for ', 'carzine');
        ...
        echo "<li>" . __('Archive for  Author', 'carzine');
        echo '</li>';
    } elseif (isset($_GET['paged']) && !empty($_GET['paged'])) {
        echo "<li>Blog Archives";
        echo '</li>';
    } elseif (is_search()) {
        echo "<li>" . __('Search Results', 'carzine');
        echo '</li>';
    }
    echo '</ul>';
}
...
?>
                ...
                <?php while ($r->have_posts()) : $r->the_post(); ?>
                    <li>
                        ...
                        <a href="<?php the_permalink(); ?>">
                            <?php if (has_post_thumbnail()) : the_post_thumbnail('', array('class' => 'video_widget img-responsive'));
                            endif; ?>
                        </a>
    ...
    function form($instance)
    {
        ...
        <p><input class="checkbox" type="checkbox" <?php checked($show_date); ?> id="<?php echo $this->get_field_id('show_date'); ?>" name="<?php echo $this->get_field_name('show_date'); ?>" />
            <label for="<?php echo $this->get_field_id('show_date'); ?>"><?php _e('Display post date?', 'carzine'); ?></label>
        </p>
<?php
    }
}
